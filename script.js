    ...
    function initAudioSystem() {
        ...
        function updateToggleUI() {
            ...
            toggleBtn.innerHTML = isMuted 
                ? '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-volume-x"><path d="M11 4.702a.705.705 0 0 0-1.203-.498L5.413 8.587A2 2 0 0 1 4.103 9H2a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h2.103a2 2 0 0 1 1.31.413l4.384 4.383a.705.705 0 0 0 1.203-.498z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/></svg>' 
                : '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-volume-2"><path d="M11 4.702a.705.705 0 0 0-1.203-.498L5.413 8.587A2 2 0 0 1 4.103 9H2a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h2.103a2 2 0 0 1 1.31.413l4.384 4.383a.705.705 0 0 0 1.203-.498z"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>';
        }
